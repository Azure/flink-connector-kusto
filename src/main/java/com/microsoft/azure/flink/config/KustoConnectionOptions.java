...
public class KustoConnectionOptions implements Serializable {
  ...
  private KustoConnectionOptions(String clusterUrl, String database, String table, String appId,
      String appKey, String tenantId, boolean isManagedIdentity, String managedIdentityAppId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(clusterUrl, that.clusterUrl) && Objects.equals(database, that.database)
  ...
  public static class Builder {
    ...
    public KustoConnectionOptions build() {
      return new KustoConnectionOptions(clusterUrl, database, table, appId, appKey, tenantId,
          isManagedIdentity, managedIdentityAppId);
    }
  }
}
